...
(def test-records 
  [(->FinancialRecord (.toDate (date-time 2013 12 04)) "Reference" 598.36M nil)
   (->FinancialRecord (.toDate (date-time 2013 12 07)) "BLIZZARD ENT*WOW SUB   800-592-5499" -12.9M nil)])
